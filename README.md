LC3_Assembly is an assembler that takes asm file and outputs obj file, that can be executed later. Usage: '.\path\to\executable.exe path\file.asm swap_endianness(default=true)'
